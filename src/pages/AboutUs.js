                        ...
                        <div className="row about-bx2 style-1 align-items-center">
                            ...
                            <div className="col-lg-6 about-content ps-lg-5 m-b30">
                                <div className="section-head">
                                    ...
                                    <p className="m-0 lh-base">We are an independent trading platform that is committed to working with you to gain the results you want. Whether your aim is to loose weight</p>
                                </div>
                ...
                <section className="content-inner bg-light pricing-plan-wrapper2">
                    ...
                    <div className="container">
                        <div className="section-head text-center">
                            <h2 className="title">Awesome Pricing Plan for <br /> commodities Business</h2>
                        </div>
