        ...
        <>
            <footer className="site-footer style-1" id="footer">
                        ...
                        <div className="row">
                            <div className="col-xl-4 col-lg-12 col-md-12" >
                                <div className="widget widget_about">
                                    ...
                                    <p>BidVerse Website by Bidverse </p>
                                    ...
                                    <div className="widget-post-bx">
                                        <div className="widget-post clearfix">
                                            <div className="dz-info">
                                                ...
                                                <span className="post-date"> JULY 29, 2023</span>
                                            </div>
                                        </div>
                            ...
                            <div className="col-xl-3 col-lg-4 col-sm-12" >
                                <div className="widget widget_locations">
                                    ...
                                    <div className="clearfix">
                                        ...
                                        <p>Number 11, Station Way, Working, GU22 7PX, United Kingdom, +447488316875</p>
                                        <img src={flags} alt="" />
                                    </div>
                                </div>
                            </div>
                ...
                <div className="footer-bottom text-center">
                    <div className="container">
                        <span className="copyright-text">Copyright © 2023 <a href="https://bidverse.org/" target="_blank">Bidverse</a>. All rights reserved.</span>
                    </div>
                </div>
            </footer>
        </>
