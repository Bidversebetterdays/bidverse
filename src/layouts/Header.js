                    ...
                    <div className="main-bar clearfix">
                        <div className="container clearfix">
                            <div className="logo-header">
                                <Link to={"/"} className="logo-dark"><img src={LogoWhite} style={{width:50,height:60}} alt="" /></Link>
                                <Link to={"/"} className="logo-light"><img src={LogoWhite} style={{width:50,height:50}}  alt="" /></Link>
                            </div>
                            ...
                            <div className="extra-nav">
                                <div className="extra-cell">
                                    <a className="btn btn-outline-primary text-white" target="_blank" rel="noreferrer" href="/login">Login</a>
                                    <a className="btn btn-primary btn-gradient btn-shadow" target="_blank" rel="noreferrer" href="/page-register">Register</a>
                                </div>
                            </div>                           
